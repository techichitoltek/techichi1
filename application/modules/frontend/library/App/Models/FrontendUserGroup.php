...
class FrontendUserGroup extends App_Model
{
    /**
     ...
     * @access protected
     */
    protected $_name = 'frontend_users_groups';
     ...
     * @access protected
     */
    protected $_rowClass = 'App_Table_FrontendUserGroup';
