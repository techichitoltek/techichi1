...
--
-- Host: localhost
-- Generation Time: Dec 26, 2015 at 08:03 PM
...
(1, 'Céline', 'Admin', 'admin', 'bdaa6f66f898f0aa133fa5fc434a724b974b4c94', 0, 'adressemail@mail.fr', '123456789', '2015-12-26 17:52:56', 1, NULL, 0);
...
(999, 1, 'ROUX', 'celine', NULL, 'adressemail@mail.fr', 1, NULL, NULL, '2015-06-30 00:00:00', '2015-12-26 17:56:54');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Table des logs des mails' AUTO_INCREMENT=190 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=135 ;
...
(8, 1, 'MAIL.SMTP_USERNAME', 'FRAMEWORK', 'adressemail@mail.fr', 1),
...
(13, 1, 'MAIL.ROBOT.FROM_EMAIL', 'FRAMEWORK', 'adressemail@mail.fr', 1),
(14, 1, 'MAIL.ROBOT.DESTINATAIRE_EMAIL', 'FRAMEWORK', '', 1),
(15, 1, 'MAIL.ROBOT.DESTINATAIRE_USERNAME', 'FRAMEWORK', '', 1),
(16, 1, 'MAIL.INCIDENT_ADDRESS', 'FRAMEWORK', 'adressemail@mail.fr', 1),
...
(86, 1, 'MAIL.ROBOT.REPLY_TO_MAIL', 'FRAMEWORK', 'no-reply.adressemail@mail.fr', 1),
(212, 3, 'MAIL.INCIDENT_ADDRESS', 'FRAMEWORK', 'adressemail@mail.fr', 1),
...
(204, 3, 'MAIL.SMTP_USERNAME', 'FRAMEWORK', 'adressemail@mail.fr', 1),
...
(185, 2, 'MAIL.INCIDENT_ADDRESS', 'FRAMEWORK', 'adressemail@mail.fr', 1),
...
(177, 2, 'MAIL.SMTP_USERNAME', 'FRAMEWORK', 'adressemail@mail.fr', 1),
...
(8, 'MAIL.SMTP_USERNAME', 'FRAMEWORK', 'adressemail@mail.fr', 'Username SMTP', 1, 1),
...
(16, 'MAIL.INCIDENT_ADDRESS', 'FRAMEWORK', 'adressemail@mail.fr', 'Email pour l''envoi des rapports d''erreur', 1, 1),
