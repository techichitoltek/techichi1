 ...
 */
class App_Tool_Project_Provider_ZfsAction extends Zend_Tool_Project_Provider_Action
{
	/**
     * createResource()
     *
     ...
     */
    public function create($name, $controllerName = 'Index', $viewIncluded = true, $module = 'backoffice')
    {
        ...
        if ($viewIncluded) {
            $viewResource = App_Tool_Project_Provider_ZfsView::createResource($this->_loadedProfile, $name, $controllerName, $module);
